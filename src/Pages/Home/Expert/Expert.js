...
import './Expert.css'
import expertImage from '../../../images/imigrationExpert.png'

const Expert = () => {
    return (
        <div className='expert_area container'>
            <div className="expert_img">
                <img src={expertImage} alt="" />
            </div>
            <div className="expert_info">
                <h2>The Leading Visa &<br /> <span className='highlight'>Immigration Expert</span> Lawyers Since 1990</h2>
